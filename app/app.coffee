define [
  ...
  app =
    ...
    dataloggersFeed:
      ...
      #url: "http://anfwebl.ucsd.edu:6999/http/dlmon/instances/ta/status.json?callback=?"
      url: "http://anfdevl.ucsd.edu:6999/http/dlmon/instances/ta/status.json?callback=?"
      type: "dlmon"
...
api - Wiring Error"""
  ...
  return _.extend app, {
    ...
    useLayout: (name, options) ->
      ...
      if @layout
        console.log "removing existing layout " + @layout.options.template
        @layout.remove
